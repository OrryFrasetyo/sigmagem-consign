    ...
    <div class="h-full max-w-7xl mx-auto py-6 mt-20">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach ($products as $product)
                <div class="bg-gray-800 shadow-md border border-transparent rounded-lg overflow-hidden block relative">
                    @if ($product->stok == 0)
                        <!-- Label Produk Habis, tidak terpengaruh opacity -->
                        <span
                    ...
                    <a href="{{ $product->stok == 0 ? '#' : route('product.detail', $product->id) }}"
                        ...
                        <!-- Bagian yang memudar (gambar dan informasi produk) -->
